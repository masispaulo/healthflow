...
const AnalysisDashboard: React.FC<AnalysisDashboardProps> = ({ analysis, procedureCount }) => {
  ...
  // Estado para a calculadora de risco
    ...
    <div className="space-y-6 animation-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-800 p-4 rounded-lg border border-slate-700 shadow-lg flex items-center gap-4">
          <div className="p-3 bg-purple-900/30 text-purple-400 rounded-full">
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>
          </div>
          <div>
        ...
        <div className="bg-slate-800 p-4 rounded-lg border border-slate-700 shadow-lg flex items-center gap-4">
          ...
          <div>
            <p className="text-xs text-slate-400 uppercase font-semibold">Risco (&gt;{targetTime}m)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-slate-800 p-6 rounded-lg border border-slate-700 shadow-lg">
          ...
          <p className="text-sm text-slate-400 mb-6">Probabilidade estatística baseada no histórico.</p>
        ...
        <div className="lg:col-span-1 bg-slate-800 p-6 rounded-lg border border-slate-700 shadow-lg flex flex-col justify-center">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-900 border border-slate-600 rounded-lg text-white text-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
            />
          </div>
          <div className="text-center p-6 bg-slate-900/50 rounded-xl border border-slate-700">
            <p className="text-slate-400 text-sm mb-1">Chance de estourar o tempo</p>
