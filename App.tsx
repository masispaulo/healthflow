...
const App: React.FC = () => {
  ...
  const handleSelectShift = (id: string | null) => {
    ...
    if (id) {
      setTimeout(() => {
        document.getElementById('procedures-area')?.scrollIntoView({ behavior: 'smooth' });
      }, 100);
    }
  };
  ...
  if (authLoading)
    return (
      <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center font-bold animate-pulse">
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="text-center space-y-6">
          <h1 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-600 mb-2">
            HealthFlow
          </h1>
          ...
          <button
            ...
            className="bg-white text-slate-900 px-8 py-3 rounded-full font-bold hover:bg-indigo-50 transition-colors shadow-lg flex items-center gap-2 mx-auto"
          >
      ...
      <main className="container mx-auto p-4 lg:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {/* ✅ LocationsManager só renderiza depois do authLoading */}
            {!authLoading && (
              <LocationsManager
                locations={locations}
            ...
            <div className="bg-slate-800 rounded-2xl border border-slate-700 shadow-xl overflow-hidden">
              ...
              <div className="p-2">
                <RosterSideCalendar
                  user={user}
                  locations={locations}
                  onDateSelect={handleDateSelectFromRoster}
                />
              </div>
            </div>
